...
func main() {
	...
	r.GET("/penggajian", controllers.TampilPenggajian)
	r.POST("/penggajian", controllers.TambahPenggajian)
	r.PUT("/penggajian", controllers.UbahPenggajian)
	r.DELETE("/penggajian", controllers.HapusPenggajian)
